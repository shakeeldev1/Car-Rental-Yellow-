  ...
  return (
    <div className="flex min-h-screen items-center justify-center p-4">
      <div className="flex flex-col md:flex-row w-full max-w-5xl bg-white shadow-2xl rounded-2xl overflow-hidden transform transition-all duration-300 hover:shadow-3xl">
        ...
        <div className="w-full md:w-1/2 flex flex-col p-8 md:p-12">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600 text-lg">
              ...
              <Link to="/sign-up" className="text-[#b6aa03] font-semibold hover:text-[#9a9002] transition-colors duration-300 cursor-pointer underline decoration-2 decoration-[#b6aa03]">
                Sign up
              </Link>
            </p>
          </div>
          ...
          <form onSubmit={handleLogin} className="space-y-6">
            ...
            <div className="flex items-center justify-between mb-2">
              <div className="flex items-center space-x-2">
                <input 
                  ...
                  className="w-4 h-4"
                />
                <label htmlFor="remember" className="text-gray-600 text-sm font-medium cursor-pointer">Remember me</label>
              </div>
              <Link to="/forgot-password" className="text-[#b6aa03] font-semibold cursor-pointer text-sm hover:text-[#9a9002] transition-colors duration-300">
                Forgot password?
              </Link>
            </div>
            ...
            {/* Login Button */}
            <button 
              className="w-full mt-4 bg-gradient-to-r from-[#b6aa03] to-[#c8bc1a] text-white p-4 cursor-pointer rounded-xl font-semibold text-lg hover:from-[#9a9002] hover:to-[#b6aa03] transition-all duration-300 transform hover:-translate-y-0.5 shadow-lg hover:shadow-xl disabled:opacity-50 disabled:transform-none disabled:hover:shadow-lg"
              type="submit"
              disabled={isLoading}
            >
              {isLoading ? (
        ...
        {/* Right Side - Image */}
        <div className="hidden md:flex w-1/2 bg-gradient-to-br from-[#f8f7e6] to-[#f0eed0] items-center justify-center p-8 relative overflow-hidden">
          ...
          <div className="relative z-10 text-center">
            ...
            <div className="mt-8 text-gray-700">
              ...
              <p className="text-gray-600">We're excited to have you back. Continue your journey with us.</p>
            </div>
          </div>
          {/* Decorative elements */}
