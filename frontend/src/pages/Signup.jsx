...
export default function RegisterPage() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center p-4">
      <div className="flex flex-col md:flex-row w-full max-w-5xl bg-white shadow-2xl rounded-2xl overflow-hidden transform transition-all duration-300 hover:shadow-3xl">
        {/* Left Side - Enhanced */}
        <div className="hidden md:flex w-1/2 bg-gradient-to-br from-gray-50 to-[#f8f7e8] items-center justify-center p-8 relative overflow-hidden">
          ...
          <div className="relative z-10 text-center">
            ...
            <p className="text-gray-600 text-sm max-w-md">
              Create your account and discover a world of possibilities. Start your journey with us today.
            </p>
          </div>
        </div>

        {/* Right Side - Enhanced */}
        <div className="w-full md:w-1/2 flex flex-col p-8 md:p-12 bg-white relative">
          {/* Decorative Elements */}
          ...
          <form className="space-y-6" onSubmit={handleRegister}>
            <div className="grid grid-cols-1 gap-4">
              ...
              <div className="space-y-2">
                ...
                <input
                  type="number"
                  name="phone"
                  className="w-full border border-gray-200 p-4 rounded-xl text-gray-800 focus:outline-none focus:ring-2 focus:ring-[#b6aa03] focus:border-transparent transition-all duration-200 bg-gray-50 placeholder-gray-400 [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none"
              ...
              <div className="flex items-center">
                <div className="relative">
                  <input
                    ...
                    onChange={handleChange}
                  />
                  <div className={`w-5 h-5 border-2 rounded-md flex items-center justify-center transition-all duration-200 cursor-pointer ${
                    formData.rememberMe 
                ...
                <label
                  htmlFor="remember"
                  className="ml-3 text-gray-600 text-sm font-medium cursor-pointer hover:text-gray-800 transition-colors duration-200"
                >
                  Remember me
                </label>
              </div>
            ...
            <button
              type="submit"
              className={`w-full bg-gradient-to-r from-[#b6aa03] to-[#9c9202] text-white p-4 rounded-xl font-bold text-lg shadow-lg hover:shadow-xl transform transition-all duration-300 hover:scale-[1.02] active:scale-[0.98] ${
          ...
          <div className="mt-8 text-center">
            <p className="text-xs text-gray-500">
              ...
              <button type="button" className="text-[#b6aa03] font-medium hover:underline">
                Terms of Service
              </button>{" "}
              and{" "}
              <button type="button" className="text-[#b6aa03] font-medium hover:underline">
