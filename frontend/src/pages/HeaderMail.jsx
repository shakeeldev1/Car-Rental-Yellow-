            ...
            <div className=' mx-auto w-full sm:w-11/12'>
                <div className='flex flex-wrap gap-2 text-black justify-center sm:justify-between items-center'>
                    <div className='sm:w-[40%] flex items-center flex-wrap gap-2 '>
                        <span><FaPhone fontSize={23} className='rotate-90' /></span>
                        <span className=' sm:text-lg'>5267-214-392</span>
                        <span><HiOutlineDotsVertical fontSize={23} /></span>
                        <span><MdMarkEmailUnread fontSize={23} /></span>
                        <span className=' sm:text-lg'>needhelp@company.com</span>
                    </div>
                    <div className='sm:w-[20%]  flex items-center flex-wrap gap-2'>
                        {/* Facebook Button */}
                        <button className="w-10 h-10 flex items-center justify-center relative overflow-hidden border border-black/15 rounded-full bg-white shadow-md shadow-gray-200 group transition-all duration-300">
                        ...
                        {/* Instagram Button */}
                        <button className="w-10 h-10 flex items-center justify-center rounded-full relative overflow-hidden border border-black/15 bg-white shadow-md shadow-gray-200 group transition-all duration-500">
                        ...
                        {/* Twitter Button */}
                        <button className="w-10 h-10 flex items-center justify-center rounded-full relative overflow-hidden border border-black/15 bg-white shadow-md shadow-gray-200 group transition-all duration-300">
